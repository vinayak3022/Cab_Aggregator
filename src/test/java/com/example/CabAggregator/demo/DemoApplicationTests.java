package com.example.CabAggregator.demo;

import com.example.CabAggregator.controllers.CabController;
import com.example.CabAggregator.controllers.RiderController;
import com.example.CabAggregator.exceptions.*;
...
import com.example.CabAggregator.strategies.impl.DefaultCabMatchingStrategy;
import com.example.CabAggregator.strategies.impl.DefaultPricingStrategy;
...
class DemoApplicationTests {
	...
	void setUp() {
		...
		cabsController = new CabController(cabService, tripService);
		ridersController = new RiderController(riderService, tripService);
	}
